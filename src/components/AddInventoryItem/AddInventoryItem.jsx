    ...
    <form className="add-item__form" onSubmit={saveHandler}>
      <div className="details-sections">
        <div className="add-item__form-section item-details">
          ...
          <input
            className={`add-item__input ${emptyFields.name ? "error" : ""}`}
            type="text"
            id="item-name"
            value={name}
          ...
          <label className="add-item__label" htmlFor="item-desc">
            Description
          </label>
          <textarea
            className={`add-item__textareaInput ${
          ...
          <div
            className={`${
              emptyFields.description ? "error-message" : "error-message_hide"
            }`}
          >
            <img className="error_icon" src={errorIcon} />
            This field is required
          </div>
          <label className="add-item__label" htmlFor="wh-city">
            Category
          </label>
          <select
        ...
        <div className="add-item__form-section item-availability">
          ...
          <label className="add-item__label" htmlFor="item-status">
            Status
          </label>
          ...
          <div
            className={`${
              emptyFields.stockStatus ? "error-message" : "error-message_hide"
            }`}
          >
            <img className="error_icon" src={errorIcon} />
            This field is required
